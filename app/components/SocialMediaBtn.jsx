...
const SocialMediaBtn = () => {
  return (
    <div className="flex flex-row items-center">
        <Link className="mx-2 bg-orange-light rounded-full p-2" href="https://www.facebook.com/">
        ...
        <Link className="mx-2 bg-orange-light rounded-full p-2" href="https://www.youtube.com/">
